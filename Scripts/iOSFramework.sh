...
[ -n "${BUILT_PRODUCTS_DIR}" ] || { echo "Run from Xcode"; exit 1; }

# Define these to suit your nefarious purposes
                 FRAMEWORK_NAME=Socialize
                       LIB_NAME=libSocialize
              FRAMEWORK_VERSION=A
                     BUILD_TYPE=Release
...
env >/tmp/envdump
ARM_FILES="${BUILD_DIR}/${CONFIGURATION}-iphoneos/${LIB_NAME}.a"
I386_FILES="${BUILD_DIR}/${CONFIGURATION}-iphonesimulator/${LIB_NAME}.a"
